...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> resID=bundle.getIntegerArrayList(key);
					 ...
					 new BroadcastReceiver() {
						 ...
						 public void onReceive(Context context, Intent intent) {
							 ...
							 if (getResultCode() != MainActivity.IS_ALIVE) {
								 ...
								 NotificationManager mNotify = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
								 mNotify.notify(MY_NOTIFICATION_ID, notificationBuilder.build());
